...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
  ...
  <body>
                ...
                <div class="reservation-form">
                  ...
                  <div class="swin-sc swin-sc-contact-form light mtl">
                    <form action="" method="POST">
                      ...
                      <div class="form-group">
                        <div class="swin-btn-wrap center"><button href="#" class="swin-btn center form-submit"> <span>Book Table</span></button></div>
                      </div>
                      <?php 
    ...
    <script src="assets/vendors/bootstrap-datepicker/locales/bootstrap-datepicker.es.min.js"></script>
